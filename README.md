...
![Color_table](./assets/learning/Minecraft_Formatting.webp)
...
Minecraft allows you to create custom hex colors since 1.16. These can be useful for servers. Apply a custom hex color with the `§f§f§0§0§0§0` format.
